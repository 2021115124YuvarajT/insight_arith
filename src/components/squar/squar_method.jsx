export default function Squar_method(){
    return(
        <div style={{'font-size':'xx-large','width':'1200px','margin-left':'220px'}}>
            <h1>SQUARING USING DWANDWA</h1>
            ...
            <p>Assume that there are two rulers. One of them is covering all the digits of the number except the last. The second ruler is to the right of the last digit.Calculate the Dwandwa for the set of digits not covered by the ruler.</p>
            <p style={{'display':'inline','margin-right':'150px'}}><span style={{'background-color':'white'}}>53</span>9<sup>2</sup></p>
            <p  style={{'display':'inline'}} >D(9)=81</p>
            <p> <p>In the answer, write the last digit 1 and keep 8 as the carry</p></p>
            <p style={{'display':'inline','margin-right':'150px'}}>539<sup>2</sup>=</p>
            <p  style={{'display':'inline'}} >1(carry=8)</p>
            
            
            
            <h3>Step 2:</h3>
            <p style={{'display':'inline','margin-right':'150px'}}><span style={{'background-color':'white'}}>5</span>39<sup>2</sup></p>
            <p  style={{'display':'inline'}}>       D(39) = 54</p>
            ...
            <p style={{'display':'inline','margin-right':'150px'}}>539<sup>2</sup>=</p>
            <p  style={{'display':'inline'}} >21(carry=6)</p>
            

            <h3>Step 3:</h3>
            <p style={{'display':'inline','margin-right':'150px'}}><span style={{'background-color':'white'}}></span>539<sup>2</sup></p>
            <p  style={{'display':'inline'}}>        D(539) = 99</p>
            <p>Repeating the above step, we get</p>
            <p style={{'display':'inline','margin-right':'150px'}}>539<sup>2</sup>=</p>
            <p  style={{'display':'inline'}} >521(carry=10)</p>
            ...
            <h3>Step 4:</h3>
            <p style={{'display':'inline','margin-right':'150px'}}>53<span style={{'background-color':'white'}}>9</span><sup>2</sup></p>
            <p  style={{'display':'inline'}}>        D(53) = 30</p>
            <p>.</p>
            <p style={{'display':'inline','margin-right':'150px'}}>539<sup>2</sup>=</p>
            <p  style={{'display':'inline'}} >_ _ 0521(carry=4)</p>
            ...
            <h3>Step 5:</h3>
            <p style={{'display':'inline','margin-right':'150px'}}>5<span style={{'background-color':'white'}}>39</span><sup>2</sup></p>
            <p  style={{'display':'inline'}}>1       D(5) = 25</p>
            ...
            <p style={{'display':'inline','margin-right':'150px'}}>539<sup>2</sup>=</p>
            <p  style={{'display':'inline'}} >290521</p>
