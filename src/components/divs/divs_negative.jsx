export default function Divs_negative(){
    return(
        <div style={topcontainer}>
            ...
            <h3>The Rules are:-</h3>
            <ol>
                <li>For Numbers ending with 1:- Simply Drop the 1 in the Units place.
</li>
                ...
                <ol>
                    ...
                    <li>	For Numbers Ending with 3:- Multiply with 7, Drop the 1 in the Units place
</li>
