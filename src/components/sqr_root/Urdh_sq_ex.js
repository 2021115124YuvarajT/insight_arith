  ...
  return (
    <div>
      ...
      <div class='body'>
        ...
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/mish7.gif'/></p>
        ...
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/mish6.gif'/></p>
        <p class='center-para'>New P.D  =  27 - D(4) = 27 -16 = 11</p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/mish5.gif'/></p>
        <p class='center-para'>11 = 8 x 1 +  3  Hence quotient = 1 , remainder = 3
        <br/>New P.D  =  30 - D(41) =  22</p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/mish4.gif'/></p>
        ...
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/corr3.gif'/></p>
        <p class='center-para'>New P.D = 110 - D ( 4124) = 74</p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/corr2.gif'/></p>
        ...
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/sqrt/images/corr1.gif'/></p>
        ...
        <button className="back" onClick={()=>navigate(-1)}>Back to where you left</button><br/>
      </div>
