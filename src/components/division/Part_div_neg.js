...
const Part_div_neg = () => {
  ...
  return (
    ...
    <Sidenavbar/>
    <div className="body">
    <h3 class='main_heading'>WHEN PARTIAL DIVIDEND IS NEGATIVE</h3>
    <hr/>
    ...
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/ex201.gif'/></p>
    <p>In the next step we prefix 1 to 4 and subtract 21 from it to obtain the partial dividend.</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/ex202.gif'/></p>
    ...
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/ex203.gif'/></p>
    <p>We can now proceed further without any hitch. The next two steps are</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/ex204.gif'/></p>
    <p>and</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/ex205.gif'/></p>
    <p>Since we've obtained 3 digits as the quotient, the next partial dividend is nothing but the remainder.</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/ex206.gif'/></p>
    ...
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/exam201.gif'/></p>
    <p>At this stage, the partial dividend becomes negative. So we make a correction and proceed further.</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/exam202.gif'/></p>
    ...
    <br/>
    <button style={{'margin-left':'45%'}}onClick ={()=>navigate(-1)}>BACK to URDHVA TIRYAKA </button>
    <br/>
    </div>
    </div>
  )
