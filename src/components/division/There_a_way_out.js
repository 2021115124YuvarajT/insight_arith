...
const There_a_way_out = () => {
  ...
  return (
    <div>
        <Sidenavbar/>
      <div class='body'>
      <h3 class='main_heading'>USE OF MISHRANK</h3>
      <hr/>
        ...
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/image27.gif'/></p>
        <p>P.D = 29 - (8 x 3  + 9 x 1) = 29 - 33 =  -4</p>
        <p>-4 = -1 x 5 +  1 </p>
        <p>In the next step, we again get a negative partial dividend. This is tackled by the use of Mishrank.</p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/image29.gif'/></p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/image32.gif'/></p>
        <p class='main_heading'>-5 = -2 x 5 + 3 </p>
        <p>The next step is:</p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/image49.gif'/></p>
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/image50.gif'/></p>
        ...
        <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/exam401.gif'/></p>
