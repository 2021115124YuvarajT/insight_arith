...
const Few_ex = () => {
  ...
  return (
    <div>
      <Sidenavbar/>
    <div className="body">
    <h3 class='main_heading'>FEW EXAMPLES</h3>
    <p>Let's now look at a few more examples  where the divisors have more than two digits.</p>
    <p>198467 by 478</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/exam301.gif'/></p>
    ...
    <p>5798204 by 6328</p>
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/exam302.gif'/></p>
    ...
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/cross1.gif'/></p>
    ...
    <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/cross2.gif'/></p>
