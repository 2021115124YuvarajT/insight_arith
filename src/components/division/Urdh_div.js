...
const Urdh_div = () => {
  return (
    <div class='body'>
      <h3 class='main_heading'>URDHVA TIRYAKA - STRAIGHT DIVISION TECHNIQUE</h3>
      <hr/>
      ...
      <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step01.gif'/></p>
      ...
      <p></p>
      <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step02.gif'/></p>
      ...
      <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step03.gif'/></p>
      <p>Now our new partial dividend is 37 - 4 x 7 which is 9. Dividing 9 by 8 yields a quotient of 1 and a remainder of 1.</p>
      <p class='img-wrapper'><img src= 'http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step04.gif'/></p>
      ...
      <p class='img-wrapper'><img src= 'http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step05.gif'/></p>
      ...
      <br/>
      <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step07.gif'/></p>
      <p>followed by:</p>
      <p class='img-wrapper'><img src='http://insight.sabarirb.org/Reading%20Materials/maths/arith/div/examples/step06.gif'/></p>
